...
TorsoColaborador3D::TorsoColaborador3D(const std::string & filename) : Objeto3D(){
  ...
  hijos[0] -> setColor(_vertex3<float>(242.0/255.0, 140.0/255.0, 25.0/255.0)); // Nuanced Orange
  ...
  hijos[1] -> setColor(_vertex3<float>(242.0/255.0, 140.0/255.0, 25.0/255.0));
  hijos[1] -> setAmb(_vertex4<float>(115.0/255.0, 51.0/255.0, 0.0/255.0, 1.0));
  hijos[1] -> setDiff(_vertex4<float>(242.0/255.0, 140.0/255.0, 25.0/255.0, 1.0));
