...
TorsoAldeano3D::TorsoAldeano3D(const std::string & filename) : Objeto3D(){
  ...
  hijos[0] -> setTranformacion(_vertex4<float>(Escalado_, 1.0, 1.5, 0.5));
   hijos[0] -> setColor(_vertex3<float>(217.0/255.0, 25.0/255.0, 25.0/255.0)); // Nuanced Red
   hijos[0] -> setAmb(_vertex4<float>(102.0/255.0, 13.0/255.0, 13.0/255.0, 1.0));
   hijos[0] -> setDiff(_vertex4<float>(217.0/255.0, 25.0/255.0, 25.0/255.0, 1.0));
