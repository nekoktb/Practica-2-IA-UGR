...
PiernaAldeano3D::PiernaAldeano3D() : Objeto3D(){
  ...
  hijos[1] -> setColor(_vertex3<float>(20.0/255.0, 20.0/255.0, 20.0/255.0)); // Dark Gray / Black shoes
  hijos[1] -> setAmb(_vertex4<float>(10.0/255.0, 10.0/255.0, 10.0/255.0, 1.0));
  hijos[1] -> setDiff(_vertex4<float>(20.0/255.0, 20.0/255.0, 20.0/255.0, 1.0));
  hijos[1] -> setSpec(_vertex4<float>(0.0, 0.0, 0.0, 1.0));
