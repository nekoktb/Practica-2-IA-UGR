...
Objeto3D::Objeto3D(std::string archivo){
  ...
  // Default color and materials
  colores = _vertex3<float>(0.7, 0.7, 0.7);
  matAmb = _vertex4<float>(0.28, 0.28, 0.28, 1.0);
  matDiff = _vertex4<float>(0.7, 0.7, 0.7, 1.0);
  matSpec = _vertex4<float>(0.2, 0.2, 0.2, 1.0);
}
